...
Cómo mínimo se esprean unos 200 o 300 casos en total.  

Debe considerarse los casos periddos y aquellos que puedan ser eliminados por ser casos atípicos. 
...
Las correlaciones policóricas son una medida de asociación entre variables ordinales que se basa en la teoría de correlación de Pearson y tiene en cuenta la naturaleza discreta de los datos. Se utilizan comúnmente en estudios que involucran variables ordinales con un gran número de categorías o niveles.
