...
class: center middle main-title section-title-9 top-logo
...
.box-1.medium.sp-after-half[Presentación, resultados de aprendizaje y específicos]

--

.box-3.medium.sp-after-half[Contenidos, bibliografía, evaluaciones y ayudantías]

--

.box-6.medium.sp-after-half[Página y delegado del curso]
...
.box-6.medium.sp-after-half[Objetivos de la sesión]

--

.box-3.medium.sp-after-half[¿Dónde se sitúa la estadística y el uso de software en el proceso de investigación?]
...
.box-6.medium.sp-after-half[Bibliografía y otros recursos para profundizar]
...
.box-8.small.sp-after-half[Manejar bases de datos complejas. 
...
Queda pendiente insertar tabla con kable
...
.box-8.small.sp-after-half[Progresivamente se ha generalizado el uso de software estadístico en ciencias sociales, abriendo grandes posibilidades de realizar análisis más complejos y facilitando su uso.
...
.box-3[ R es un software y un lenguaje de programación, ambos de carácter libre, enfocado principalmente en el análisis y visualización de datos. Es desarrollado por The R Foundation for Statistical Computing.
...
.small[
.box-1-inv.large[Para algunos análisis R se basa en Java, el problema es que nuestros computadores suelen instalar de manera automática la versión de 32 bits, porque los navegadores de internet funcionan (o funcionaban) en esta arquitectura, pero nuestro computadores y R funcionan a 64 bits.
